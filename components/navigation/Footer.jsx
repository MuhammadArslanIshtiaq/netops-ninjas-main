...
export default function Footer() {
  return (
    <footer className="bg-section text-white" aria-labelledby="footer-heading">
      ...
      <Container>
        <div className="py-12 lg:py-16 border-t border-gray-500">
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            ...
            <div className="md:grid md:grid-cols-3 md:gap-8 lg:grid-cols-4 mt-12 xl:mt-0 col-span-2">
              <div className="hidden xl:block" />
              <div>
                <h3 className="text-base font-bold text-white">Links</h3>
          ...
          <div className="flex space-x-6 md:order-2">
            {navigation.social.map((item) => (
              <a
                key={item.name}
                href={item.href}
                className="p-2 rounded-full bg-secondary hover:bg-blue-500 text-white"
              >
