...
const HeroSection = () => {
  return (
    <section className="relative pt-20">
      ...
      <div className="relative z-10 py-14 sm:py-32 md:py-36 lg:py-40 text-white">
        <Container>
          <div className="text-center mx-auto max-w-2xl">
            <h1 className="text-3xl sm:text-5xl lg:text-6xl font-suiGeneris font-normal mb-10">
              We do the IT: you grow your{" "}
              <span className="text-line">Business</span>
            </h1>
            <p className="text-xl md:text-2xl font-DMSans font-normal max-w-xl mx-auto mb-12">
